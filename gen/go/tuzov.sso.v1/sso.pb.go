...
func (x *ReqisterResopnse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReqisterResopnse) ProtoMessage() {}

func (x *ReqisterResopnse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_sso_sso_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReqisterResopnse.ProtoReflect.Descriptor instead.
func (*ReqisterResopnse) Descriptor() ([]byte, []int) {
	return file_proto_sso_sso_proto_rawDescGZIP(), []int{1}
}

func (x *ReqisterResopnse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *IsAdmineResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IsAdmineResponse) ProtoMessage() {}

func (x *IsAdmineResponse) ProtoReflect() protoreflect.Message {
	mi := &file_proto_sso_sso_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IsAdmineResponse.ProtoReflect.Descriptor instead.
func (*IsAdmineResponse) Descriptor() ([]byte, []int) {
	return file_proto_sso_sso_proto_rawDescGZIP(), []int{5}
}

func (x *IsAdmineResponse) GetIsAdmin() bool {
	if x != nil {
		return x.IsAdmin
	}
	return false
...
var file_proto_sso_sso_proto_rawDesc = []byte{
	...
	0x22, 0x2b, 0x0a, 0x10, 0x52, 0x65, 0x71, 0x69, 0x73, 0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x6f,
	0x70, 0x6e, 0x73, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	...
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x2d, 0x0a, 0x10, 0x49, 0x73, 0x41, 0x64,
	0x6d, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x19, 0x0a, 0x08,
	...
	0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x6f, 0x70, 0x6e, 0x73, 0x65, 0x12, 0x30, 0x0a, 0x05, 0x4c,
	...
	0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16,
	0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x65, 0x52, 0x65,
...
var file_proto_sso_sso_proto_goTypes = []interface{}{
	...
	(*ReqisterResopnse)(nil), // 1: auth.ReqisterResopnse
	(*LoginRequest)(nil),     // 2: auth.LoginRequest
	(*LoginResponse)(nil),    // 3: auth.LoginResponse
	(*IsAdminRequest)(nil),   // 4: auth.IsAdminRequest
	(*IsAdmineResponse)(nil), // 5: auth.IsAdmineResponse
}
var file_proto_sso_sso_proto_depIdxs = []int32{
	...
	1, // 3: auth.Auth.Register:output_type -> auth.ReqisterResopnse
	3, // 4: auth.Auth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Auth.IsAdmin:output_type -> auth.IsAdmineResponse
